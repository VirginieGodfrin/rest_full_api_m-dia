...
class Battle
{
    ...
    public function getProgrammerNickname() {
        // VirtualProperty(): the serializer generates the field name by taking the method name and removing get 
        //SerializedName(): because we want this to be called programmer
